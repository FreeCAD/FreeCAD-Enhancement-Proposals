...
### Draft
 ...
 - [FEP-0012: Gating All FreeCAD Network Access](./FEPs/FEP-0012-gating-network-access/README.md) - Route all outbound network access through a single user-controllable gate with a default-deny policy.
### Active
