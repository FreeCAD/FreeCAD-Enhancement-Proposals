...
## FEP Process
See Proposal [FEP-0001: FEP Process](./FEPs/FEP-0001-process/README.md) for a complete description of the FEP process, including how to create a new proposal.
...
### Active
 ...
 - [FEP-0003: FreeCAD Release Schedule and Process](./FEPs/FEP-0003-release-schedule/README.md) - Structured release schedule for FreeCAD consisting of three releases per year with CalVer schema.
 ...
 -  [FEP-0008: Project Group Structure](./FEPs/FEP-0007-consistent-language/README.md) - Definition of the FreeCAD Project Groups Structure.
